...
cc.run({
	...
	onAccept: function (e) {
		cc.allowedCategory('analytics') &&
			($('.videoNoConsent').removeClass('videoNoConsent'), $('.ytConsentPrompt').hide());
	},
				...
				blocks: [
					{
						title: 'Cookie usage \uD83D\uDCE2',
						description:
							'I use cookies to ensure the basic functionalities of the website and to enhance your online experience. You can choose for each category to opt-in/out whenever you want. For more details relative to cookies and other sensitive data, please read the full <a href="/privacy-statement" class="cc-link">privacy policy</a>.',
					},
					{
					...
					},
					{
						...
						description:
							'For any queries in relation to our policy on cookies and your choices, please <a class="cc-link" href="mailto:webmaster@spas.com">contact us</a>.',
					},
				],
			},
		},
